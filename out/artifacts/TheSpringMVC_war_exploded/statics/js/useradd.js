...
$(function(){
	...
	if(errorInfo==null || errorInfo==""){
		a_idPicPath.next().html("*只能上传大小为500kb的文件 *格式只能是 jpg、png、jpeg、peng");
	}else {
		a_idPicPath.next().html(errorInfo.val());
	}

	if(errorInfo2==null || errorInfo2==""){
		a_workPicPath.next().html("*只能上传大小为500kb的文件 *格式只能是 jpg、png、jpeg、peng");
	}else {
		a_workPicPath.next().html(errorInfo2.val());
	}
	$.ajax({
		type:"GET",//请求类型
		url:path+"/user/selRole",//请求的url

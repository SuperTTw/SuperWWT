...
<div class="right">
	...
	<div class="providerAdd">
		<div>
			<label>供应商编码：</label>
			<input type="text" id="p_proCode" value="" readonly="readonly">
		</div>
		<div>
			<label>供应商名称：</label>
			<input type="text" id="p_proName" value="" readonly="readonly">
		</div>
		<div>
			<label>联系人：</label>
			<input type="text" id="p_proContact" value="" readonly="readonly">
		</div>
		<div>
			<label>联系电话：</label>
			<input type="text"  id="p_proPhone" value="" readonly="readonly" >
		</div>
		<div>
			<label>传真：</label>
			<input type="text" id="p_proFax" value="" readonly="readonly">
		</div>
		<div>
			<label>描述：</label>
			<input type="text" id="p_proDesc" value="" readonly="readonly">
		</div>
	</div>
    </div>
</section>
